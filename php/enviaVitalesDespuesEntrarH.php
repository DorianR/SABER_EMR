...
<?php 
   ...
   if (isset($_POST['NoPaciente'])){
	...
	$insert = sprintf("INSERT INTO SignosVitalesDesEntrar1(Pulso,FR,PresionArterial,Temperatura,InfPaciente_idPaciente) VALUES ('".$Pulso."','".$FR."','".$PresionArterial."','".$Temperatura."','".$InfPaciente_idPaciente."')");
