...
abrirReporte();        
    return false;
      ...
      <body onload="ComndosR(); DesapareceForm('formRecOpera'); DesapareceForm('form2'); DesapareceForm('formularioRevSis'); DesapareceForm('marHeridas'); DesapareceForm('subida');" >
            ...
            <!--    <div class="scroll_busqueda">
                  <h5> <b>Busqueda Pacientes </b></h5>  
                  hola</br>
                    hola</br>
                    hola</br>
                    hola</br>
                    ...
                    <div class="col-sm-6"> 	                
                      <div class="panel panel-primary">
                       ...
                       <b> <label>No. de Paciente registrado: &nbsp&nbsp</label><input type="text" id="NoPaciente"  name="NoPaciente">  </b>
                      <right>
     <button type="button" align="right" class="btn btn-success" onClick="window.open('infBasicP.php')"><span class="glyphicon glyphicon-new-window">  Nuevo Paciente </span></button>
                    ...
                    </div>                                                          <!--Termina el segundo div-->
                 <div class="col-sm-9"> 
                 <div id="AreaImp" class="scroll_vertical"> 
                  <div id="Info" name="Info">
      
                <h4  id="MostrarInfB" name="MostrarInfB" onclick="ApareceForm('form1'); DesapareceSPN(this.id); ApareceSPN('OcultarInfB'); "    a>   <b> <span class="glyphicon glyphicon-chevron-right"  > </span>  1. Info Basica de Paciente</b></h4>
            ...
            <input type="text" id="Relacion" name="Relacion" size="30%" > </br> </br>
               ...
               <center>
                   <button type="button" id="enviar" name="enviar" value="registrarInfoP" onclick=" javascript:InfoPaciente();  javascript:mostrarInfP();  javascript:validaInfoBasica();  javascript:DesapareceBtn(this.id); javascript:desactiva_Btn(this);" align="center" class="btn btn-primary btn-lg">Registrar información basica del paciente</button> 
                   <button type="button" id="enviarModINfo" style="display: none;" name="enviarModINfo" value="registrarInfoP" onclick=' UpdateInfoPaciente(); mostrarDatosPActualizado(); validaInfoBasica(); ' align="center" class="btn btn-info btn-lg">Actualizar info. del paciente</button> 
               </center>
       </form>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-2  text-right">
                                ...
                                <div class="col-xs-4">
                                    <input  type="text" name="buscar" id="buscar" class="form-control" onkeyup="lista_Pacientes(this.value);" placeholder="Ingrese nombre o descripcion"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div id="lista"></div> 
