...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysql_query("SELECT * FROM infpaciente WHERE idPaciente = 3");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($productos2 = mysql_fetch_array($productos)){
	$item = $item+1;	
	$pdf->Cell(15, 8, $item, 0);
	$pdf->Cell(70, 8,$productos2['CodigoPaciente'], 0);
	$pdf->Cell(40, 8, $productos2['PrimerNombreP'], 0);
	$pdf->Cell(25, 8, 'S/. '.$productos2['PrimerApeP'], 0);
	$pdf->Cell(25, 8, 'S/. '.$productos2['FechaNacP'], 0);
